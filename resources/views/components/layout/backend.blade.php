...
<head>
    ...
    <link href="{{ asset('backend/assets/plugins/highlight/styles/github-gist.css') }}" rel="stylesheet">
    ...
    <script type="text/javascript">
        var admin_base_url = '{{ Route('backend.dashboard.index') }}';
    </script>
    @if(isset($css))
        {{$css}}
    @endif
...
<div class="app align-content-stretch d-flex flex-wrap">
    ...
    <div class="logo">
        ...
        <div class="sidebar-user-switcher user-activity-online">
            <a href="#">
                <img src="{{ asset('backend/assets/images/avatars/avatar.png') }}">
...
<script src="{{ asset('backend/assets/plugins/highlight/highlight.pack.js') }}"></script>
